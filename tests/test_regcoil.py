...
class QuadcoilKTest(unittest.TestCase):
    ...
    def test_regcoil(self):
        ...
        print('Phi:')
        compare(nescoil_phi_mn_ans, nescoil_phi_mn['phi'], 1e-3)
        print('f_B:')
        ...
        print('Phi:')
        compare(regcoil1_phi_mn_ans, regcoil1_phi_mn['phi'], 1e-3)
        print('f_B:')
        ...
        print('Phi:')
        compare(regcoil2_phi_mn['phi'], regcoil2_phi_mn_ans, 1e-3)
        print('f_B:')
